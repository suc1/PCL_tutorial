...
printUsage (const char* progName)
{
  std::cout << "\n\nUsage: "<<progName<<" [options]\n\n"
            ...
            << "\n\n"
            << "q: exit\n"
            << "r: centre and zoom the viewer \n"
            << "clicking and dragging: rotate the viewpoint \n"
            << "zoom in and out: scroll wheel, or right-click and drag up and down\n"
            << "move the camera: Middle-clicking and dragging\n"
            << "\n\n";
}
